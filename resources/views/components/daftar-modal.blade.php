<div id="daftarModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg w-1/3 max-h-[80vh] overflow-y-auto relative">
        <!-- Tombol Close -->
        <button onclick="document.getElementById('daftarModal').classList.add('hidden')" class="absolute top-4 right-4 text-gray-700 hover:text-red-700">
        ...
        <form action="{{ route('pendaftar.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select id="golongan_darah" name="golongan_darah" class="w-full px-3 py-2 border border-gray-300 rounded" required>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 mb-1" for="riwayat_kesehatan">Riwayat Kesehatan</label>
